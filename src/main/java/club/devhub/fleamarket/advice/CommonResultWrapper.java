 ...
 * Object在@ResponseBody作用下子自动转换为json传送到客户端,但对String不起作用，需要手动转换
 * 有个坑要注意：
 ...
 */
@RestControllerAdvice(basePackages = "club.devhub.fleamarket.controller")
@Slf4j
public class CommonResultWrapper implements ResponseBodyAdvice<Object> {
     ...
     * 要使用SpringBoot的jackson自动化配置只需保证SpringBoot的web/webflux依赖引入
     * 在application.yml中进行了相关的配置
     * */
    @Autowired
    ...
    public Object beforeBodyWrite(Object body, MethodParameter returnType, MediaType selectedContentType, Class selectedConverterType, ServerHttpRequest request, ServerHttpResponse response) {
        ...
        /**
         * instanceof 判断body是不是String类
         * writeValueAsString，将集合转换为json
         * */
